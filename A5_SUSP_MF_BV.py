...
class A5_SUSP_MF_BVRoutineIdentifierSignals:
...
class A5_SUSP_MF_BVReadDataSignals:
    ...
    CABSUSP_DisplayCabSusp = DiagMessage(0x1100, 'CABSUSP_DisplayCabSusp', [1, 3, 4, 64], None, '', 1)
    CABSUSP_DisplayCabSusp.add_parameter(DiagParameter('CABSUSP_DisplayCabSusp', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'Not used': [0, 0], 'DISPLAY_OFF': [1, 1], 'DISPLAY_ON': [2, 2], 'DISPLAY_FLASH_1HZ': [3, 3], 'DISPLAY_FLASH_0_5_HZ': [4, 4], 'DISPLAY_FLASH_CUSTOM': [5, 5], 'Not usedx1': [6, 6], 'Not usedx2': [7, 7]}, 0, 7, '', False, False, False))

    CABSUSP_PopupSetting = DiagMessage(0x1101, 'CABSUSP_PopupSetting', [1, 3, 4, 64], None, '', 1)
    CABSUSP_PopupSetting.add_parameter(DiagParameter('CABSUSP_PopupSetting', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'Off': [0, 0], 'On with possibility to remove': [1, 1], 'On permanently': [2, 2], 'Not used': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_SettingValue = DiagMessage(0x1102, 'CABSUSP_SettingValue', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ControlStatus = DiagMessage(0x1103, 'CABSUSP_ControlStatus', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_DisplayFrontAxleSusp = DiagMessage(0x1104, 'FAXLESUSP_DisplayFrontAxleSusp', [1, 3, 4, 64], None, '', 1)
    FAXLESUSP_DisplayFrontAxleSusp.add_parameter(DiagParameter('FAXLESUSP_DisplayFrontAxleSusp', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'Not used': [0, 0], 'DISPLAY_OFF': [1, 1], 'DISPLAY_ON': [2, 2], 'DISPLAY_FLASH_1HZ': [3, 3], 'DISPLAY_FLASH_0_5HZ': [4, 4], 'DISPLAY_FLASH_CUSTOM': [5, 5], 'Not usedx1': [6, 6], 'Not usedx2': [7, 7]}, 0, 7, '', False, False, False))

    FAXLESUSP_Height = DiagMessage(0x1105, 'FAXLESUSP_Height', [1, 3, 4, 64], None, '', 1)
    FAXLESUSP_Height.add_parameter(DiagParameter('FAXLESUSP_Height', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'Auto': [6, 6]}, 6, 6, '', False, False, False))

    FAXLESUSP_ControlStatus = DiagMessage(0x1106, 'FAXLESUSP_ControlStatus', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_Position = DiagMessage(0x1107, 'FAXLESUSP_Position', [1, 3, 4, 64], None, '', 1)
    ...
    HW_AUTO5_APP18_125_LifeCycle = DiagMessage(0x1108, 'HW_AUTO5_APP18_125_LifeCycle', [1, 3, 4, 64], None, '', 1)
    ...
    HW_AUTO5_APP18_125_SoftwareVers = DiagMessage(0x1109, 'HW_AUTO5_APP18_125_SoftwareVers', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_PositionFrontLeft = DiagMessage(0x110A, 'CABSUSP_PositionFrontLeft', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_PositionFrontRight = DiagMessage(0x110B, 'CABSUSP_PositionFrontRight', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUP_PositionRearLeft = DiagMessage(0x110C, 'CABSUP_PositionRearLeft', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUP_PositionRearRight = DiagMessage(0x110D, 'CABSUP_PositionRearRight', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_77 = DiagMessage(0x110E, 'CABSUSP_ERR_15_77', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_78 = DiagMessage(0x110F, 'CABSUSP_ERR_15_78', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_79 = DiagMessage(0x1110, 'CABSUSP_ERR_15_79', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_7A = DiagMessage(0x1111, 'CABSUSP_ERR_15_7A', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_7B = DiagMessage(0x1112, 'CABSUSP_ERR_15_7B', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_7C = DiagMessage(0x1113, 'CABSUSP_ERR_15_7C', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_7D = DiagMessage(0x1114, 'CABSUSP_ERR_15_7D', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_7E = DiagMessage(0x1115, 'CABSUSP_ERR_15_7E', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_7F = DiagMessage(0x1116, 'CABSUSP_ERR_15_7F', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_83 = DiagMessage(0x1117, 'CABSUSP_ERR_15_83', [1, 3, 4, 64], None, '', 1)
    CABSUSP_ERR_15_83.add_parameter(DiagParameter('CABSUSP_ERR_15_83', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'No error': [0, 0], 'Error active': [1, 1], 'Not used': [2, 2], 'Not usedx1': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_ERR_15_84 = DiagMessage(0x1118, 'CABSUSP_ERR_15_84', [1, 3, 4, 64], None, '', 1)
    CABSUSP_ERR_15_84.add_parameter(DiagParameter('CABSUSP_ERR_15_84', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'No error': [0, 0], 'Error active': [1, 1], 'Not used': [2, 2], 'Not usedx1': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_ERR_15_85 = DiagMessage(0x1119, 'CABSUSP_ERR_15_85', [1, 3, 4, 64], None, '', 1)
    CABSUSP_ERR_15_85.add_parameter(DiagParameter('CABSUSP_ERR_15_85', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'No error': [0, 0], 'Error active': [1, 1], 'Not used': [2, 2], 'Not usedx1': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_ERR_15_86 = DiagMessage(0x111A, 'CABSUSP_ERR_15_86', [1, 3, 4, 64], None, '', 1)
    CABSUSP_ERR_15_86.add_parameter(DiagParameter('CABSUSP_ERR_15_86', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'No error': [0, 0], 'Error active': [1, 1], 'Not used': [2, 2], 'Not usedx1': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_ERR_15_87 = DiagMessage(0x111B, 'CABSUSP_ERR_15_87', [1, 3, 4, 64], None, '', 1)
    CABSUSP_ERR_15_87.add_parameter(DiagParameter('CABSUSP_ERR_15_87', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'No error': [0, 0], 'Error active': [1, 1], 'Not used': [2, 2], 'Not usedx1': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_ERR_15_88 = DiagMessage(0x111C, 'CABSUSP_ERR_15_88', [1, 3, 4, 64], None, '', 1)
    CABSUSP_ERR_15_88.add_parameter(DiagParameter('CABSUSP_ERR_15_88', 1, 0, 0, 8, SignalByteOrder.Intel, SignalType.LOOKUPTABLE, SignalConversion.IDENTICAL, 0, 1, {'No error': [0, 0], 'Error active': [1, 1], 'Not used': [2, 2], 'Not usedx1': [3, 3]}, 0, 3, '', False, False, False))

    CABSUSP_ERR_15_8C = DiagMessage(0x111D, 'CABSUSP_ERR_15_8C', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_8D = DiagMessage(0x111E, 'CABSUSP_ERR_15_8D', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_8E = DiagMessage(0x111F, 'CABSUSP_ERR_15_8E', [1, 3, 4, 64], None, '', 1)
    ...
    CABSUSP_ERR_15_8F = DiagMessage(0x1120, 'CABSUSP_ERR_15_8F', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_ERR_11_81 = DiagMessage(0x1121, 'FAXLESUSP_ERR_11_81', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_ERR_11_82 = DiagMessage(0x1122, 'FAXLESUSP_ERR_11_82', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_ERR_11_83 = DiagMessage(0x1123, 'FAXLESUSP_ERR_11_83', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_ERR_11_84 = DiagMessage(0x1124, 'FAXLESUSP_ERR_11_84', [1, 3, 4, 64], None, '', 1)
    ...
    FAXLESUSP_ERR_11_85 = DiagMessage(0x1125, 'FAXLESUSP_ERR_11_85', [1, 3, 4, 64], None, '', 1)
    ...
    FrontAxleCalibrationState = DiagMessage(0x1126, 'FrontAxleCalibrationState', [1, 3, 4, 64], None, '', 1)
    ...
    CabSuspCalibrationState = DiagMessage(0x1127, 'CabSuspCalibrationState', [1, 3, 4, 64], None, '', 1)
...
class A5_SUSP_MF_BVWriteDataSignals:
...
class A5_SUSP_MF_BVIOControlDataSignals:
    pass


A5_SUSP_MF_BVDTCSnapshotdDids = {
}


class A5_SUSP_MFClient(ECUClient):
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0xD1, "A5_SUSP_MF", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = A5_SUSP_MF_BVReadDataSignals
        self.write_dids = A5_SUSP_MF_BVWriteDataSignals
        self.routine_dids = A5_SUSP_MF_BVRoutineIdentifierSignals
        self.io_dids = A5_SUSP_MF_BVIOControlDataSignals
        self.dtc_snapshot_dids = A5_SUSP_MF_BVDTCSnapshotdDids
        self.long_name = ""
