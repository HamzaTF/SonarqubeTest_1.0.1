...
class A11V_BVRoutineIdentifierSignals:
...
class A11V_BVIOControlDataSignals:
    pass


A11V_BVDTCSnapshotdDids = {
}


class A11VClient(ECUClient):
    class FlashData(Enum):
        APPL = [MemoryLocation(0x00078000, 0x0, 32, 32, erase_address=0x00078000, erase_size=None,
                               ...
                               did_read_obj=deepcopy(A11V_BVReadDataSignals.ApplicationSoftwareIdentification),
                               did_fingerprint_obj=deepcopy(A11V_BVReadDataSignals.ApplicationSoftwareFingerprint),
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0xED, "A11V", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = A11V_BVReadDataSignals
        self.write_dids = A11V_BVWriteDataSignals
        self.routine_dids = A11V_BVRoutineIdentifierSignals
        self.io_dids = A11V_BVIOControlDataSignals
        self.dtc_snapshot_dids = A11V_BVDTCSnapshotdDids
        self.long_name = ""
