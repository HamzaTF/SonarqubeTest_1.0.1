...
class MULTIPAD_BVRoutineIdentifierSignals:
...
class MULTIPAD_BVReadDataSignals:
...
class MULTIPAD_BVWriteDataSignals:
...
class MULTIPAD_BVIOControlDataSignals:
    pass


MULTIPAD_BVDTCSnapshotdDids = {
}


class MULTIPADClient(ECUClient):
    class FlashData(Enum):
        APPL = [MemoryLocation(0x8010000, 0x0, 32, 32, erase_address=0x8010000, erase_size=None,
                               path_to_file="..\DLL_BIN\BIN\M2\M2_Multipad.hex",
                               ecu_reset=True, wait_time_ecu_reset=0, area_name="APPL",
                               did_read_obj=deepcopy(MULTIPAD_BVReadDataSignals.ApplicationSoftwareIdentification),
                               did_fingerprint_obj=deepcopy(MULTIPAD_BVReadDataSignals.ApplicationSoftwareFingerprint),
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0x21, "MULTIPAD", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = MULTIPAD_BVReadDataSignals
        self.write_dids = MULTIPAD_BVWriteDataSignals
        self.routine_dids = MULTIPAD_BVRoutineIdentifierSignals
        self.io_dids = MULTIPAD_BVIOControlDataSignals
        self.dtc_snapshot_dids = MULTIPAD_BVDTCSnapshotdDids
        self.long_name = ""
