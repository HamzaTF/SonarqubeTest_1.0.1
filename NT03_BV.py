...
class NT03_BVRoutineIdentifierSignals:
...
class NT03_BVIOControlDataSignals:
    pass


NT03_BVDTCSnapshotdDids = {
}


class NT03Client(ECUClient):
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0x29, "NT03", False, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = NT03_BVReadDataSignals
        self.write_dids = NT03_BVWriteDataSignals
        self.routine_dids = NT03_BVRoutineIdentifierSignals
        self.io_dids = NT03_BVIOControlDataSignals
        self.dtc_snapshot_dids = NT03_BVDTCSnapshotdDids
        self.long_name = ""
