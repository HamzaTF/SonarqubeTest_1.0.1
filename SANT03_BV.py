...
class SANT03_BVRoutineIdentifierSignals:
...
class SANT03_BVReadDataSignals:
...
class SANT03_BVWriteDataSignals:
...
class SANT03_BVIOControlDataSignals:
    BatteryPotential = DiagMessage(0x0100, 'BatteryPotential', [4], [4], '', 1)
    BatteryPotential.add_parameter(DiagParameter('BatteryPotential', 1, 0, 0, 16, SignalByteOrder.Motorola, SignalType.UINT_LINEAR, SignalConversion.LINEAR_CALCULATION, 0.0, 0.05, 'V', 0, 3212.75, '', False, False, False))


SANT03_BVDTCSnapshotdDids = {
}


class SANT03Client(ECUClient):
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0x2A, "SANT03", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = SANT03_BVReadDataSignals
        self.write_dids = SANT03_BVWriteDataSignals
        self.routine_dids = SANT03_BVRoutineIdentifierSignals
        self.io_dids = SANT03_BVIOControlDataSignals
        self.dtc_snapshot_dids = SANT03_BVDTCSnapshotdDids
        self.long_name = ""
