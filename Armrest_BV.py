...
class Armrest_BVRoutineIdentifierSignals:
...
class Armrest_BVReadDataSignals:
...
class Armrest_BVWriteDataSignals:
...
class Armrest_BVIOControlDataSignals:
    pass


Armrest_BVDTCSnapshotdDids = {
}


class ArmrestClient(ECUClient):
    class FlashData(Enum):
        APPL = [MemoryLocation(0x08010000, 0x0, 32, 32, erase_address=0x08010000, erase_size=None,
                               path_to_file="..\DLL_BIN\BIN\M2\M2_Armrest.hex",
                               ecu_reset=True, wait_time_ecu_reset=0, area_name="APPL",
                               did_read_obj=deepcopy(Armrest_BVReadDataSignals.ApplicationSoftwareIdentification),
                               did_fingerprint_obj=deepcopy(Armrest_BVReadDataSignals.ApplicationSoftwareFingerprint),
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0x21, "Armrest", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = Armrest_BVReadDataSignals
        self.write_dids = Armrest_BVWriteDataSignals
        self.routine_dids = Armrest_BVRoutineIdentifierSignals
        self.io_dids = Armrest_BVIOControlDataSignals
        self.dtc_snapshot_dids = Armrest_BVDTCSnapshotdDids
        self.long_name = ""
