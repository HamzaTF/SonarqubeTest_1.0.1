...
class CLIM_PANEL_AUTO_BVRoutineIdentifierSignals:
...
class CLIM_PANEL_AUTO_BVReadDataSignals:
...
class CLIM_PANEL_AUTO_BVWriteDataSignals:
...
class CLIM_PANEL_AUTO_BVIOControlDataSignals:
    BatteryPotential = DiagMessage(0x0100, 'BatteryPotential', [4], [4], '', 1)
    BatteryPotential.add_parameter(DiagParameter('BatteryPotential', 1, 0, 0, 16, SignalByteOrder.Motorola, SignalType.UINT_LINEAR, SignalConversion.LINEAR_CALCULATION, 0.0, 0.05, 'V', 0, 3212.75, '', False, False, False))


CLIM_PANEL_AUTO_BVDTCSnapshotdDids = {
}


class CLIM_PANEL_AUTOClient(ECUClient):
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0x8, "CLIM_PANEL_AUTO", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = CLIM_PANEL_AUTO_BVReadDataSignals
        self.write_dids = CLIM_PANEL_AUTO_BVWriteDataSignals
        self.routine_dids = CLIM_PANEL_AUTO_BVRoutineIdentifierSignals
        self.io_dids = CLIM_PANEL_AUTO_BVIOControlDataSignals
        self.dtc_snapshot_dids = CLIM_PANEL_AUTO_BVDTCSnapshotdDids
        self.long_name = ""
