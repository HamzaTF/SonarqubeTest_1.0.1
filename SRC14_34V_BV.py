...
class SRC14_34V_BVRoutineIdentifierSignals:
...
class SRC14_34V_BVReadDataSignals:
...
class SRC14_34V_BVWriteDataSignals:
...
class SRC14_34V_BVIOControlDataSignals:
    BatteryPotential = DiagMessage(0x0100, 'BatteryPotential', [4], [4], '', 1)
    BatteryPotential.add_parameter(DiagParameter('BatteryPotential', 1, 0, 0, 16, SignalByteOrder.Motorola, SignalType.UINT_LINEAR, SignalConversion.LINEAR_CALCULATION, 0.0, 0.05, 'V', 0, 3212.75, '', False, False, False))


SRC14_34V_BVDTCSnapshotdDids = {
}


class SRC14_34VClient(ECUClient):
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0xFE, "SRC14_34V", True, [], hw_id, can_channel=can_channel,
        ...
        self.routine_dids = SRC14_34V_BVRoutineIdentifierSignals
        self.io_dids = SRC14_34V_BVIOControlDataSignals
        self.dtc_snapshot_dids = SRC14_34V_BVDTCSnapshotdDids
        self.long_name = ""
