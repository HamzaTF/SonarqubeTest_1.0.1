...
class A5_VRG_BVRoutineIdentifierSignals:
...
class A5_VRG_BVReadDataSignals:
...
class A5_VRG_BVWriteDataSignals:
...
class A5_VRG_BVIOControlDataSignals:
    BatteryPotential = DiagMessage(0x0100, 'BatteryPotential', [4], [4], '', 1)
    BatteryPotential.add_parameter(DiagParameter('BatteryPotential', 1, 0, 0, 16, SignalByteOrder.Motorola, SignalType.UINT_LINEAR, SignalConversion.LINEAR_CALCULATION, 0.0, 0.05, 'V', 0, 3212.75, '', False, False, False))


A5_VRG_BVDTCSnapshotdDids = {
}


class A5_VRGClient(ECUClient):
    class FlashData(Enum):
        APPL = [MemoryLocation(0xFC0000, 0x0, 32, 32, erase_address=0xFC0000, erase_size=None,
                               path_to_file="AUTO.05_000.F.01.006.01._______.hex",
                               ecu_reset=True, wait_time_ecu_reset=0, area_name="APPL", did_read_obj=deepcopy(A5_VRG_BVReadDataSignals.ApplicationSoftwareIdentification),
                               did_fingerprint_obj=deepcopy(A5_VRG_BVReadDataSignals.ApplicationSoftwareFingerprint), did_dependency=None, consider_in_mdr=False),
    ...
    def __init__(self, routing_over_dgw=False, can_channel=1, comparam=UDSConnection.default_com_parameter,
        ...
        hw_id = 0x0
        super().__init__(0xA5, "A5_VRG", True, [], hw_id, can_channel=can_channel,
        ...
        self.kl15_relay = 0
        self.kl30_relay = 0
        self.read_dids = A5_VRG_BVReadDataSignals
        self.write_dids = A5_VRG_BVWriteDataSignals
        self.routine_dids = A5_VRG_BVRoutineIdentifierSignals
        self.io_dids = A5_VRG_BVIOControlDataSignals
        self.dtc_snapshot_dids = A5_VRG_BVDTCSnapshotdDids
        self.long_name = ""
